...
public record MMDPlayerSubmit(
    ...
    public MMDPlayerSubmit(PoseStack.Pose pose, MMDModelMesh mesh, MMDMeshEmitter.Transform transform, float alpha, MMDAnimationRuntime.AnimationEntry animation) {
        this(new Matrix4f(pose.pose()), mesh, transform, alpha, animation);
    }
